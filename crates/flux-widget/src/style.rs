...
pub fn dice_icon<'a>(color: Color, size: f32) -> Element<'a, Message> {
    const SVG: &[u8] = br##"<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36">
      ...
      <g fill="#FFFFFF" stroke="none">
        ...
        <!-- left face: 2 (UL->B face diagonal) -->
        <circle cx="7.85" cy="16.55" r="1.8"/>
        <circle cx="14.15" cy="26.45" r="1.8"/>
        <!-- right face: 3 (UR->B face diagonal, mirrors the left) -->
        <circle cx="28.5" cy="16.5" r="1.8"/>
        <circle cx="25" cy="22" r="1.8"/>
        <circle cx="21.5" cy="27.5" r="1.8"/>
      </g>
    </svg>"##;
