...
pub fn view<'a>(
    ...
    let network = column![
        row![
            ...
            Space::with_width(12),
            pslider("Arrow position", format!("{:.0}px", settings.network_arrow_spacing), 0.0, 24.0, settings.network_arrow_spacing, 16.0, 1.0, Message::SetArrowSpacing),
        ],
        Space::with_height(4),
        row![
    ...
    let disk = column![
        row![
            ...
            Space::with_width(12),
            pslider("R: / W: position", format!("{:.0}px", settings.disk_label_spacing), 0.0, 24.0, settings.disk_label_spacing, 16.0, 1.0, Message::SetDiskLabelSpacing),
        ],
        Space::with_height(4),
        row![
